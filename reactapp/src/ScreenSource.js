...
function ScreenSource(props) {
  ...
  useEffect(() => {
    const APIResultsLoading = async() => {
      ...
      console.log(`https://newsapi.org/v2/sources?language=${langue}&country=${country}&apiKey=1d0a00b0ad2944aabb853c2267cfb50c`);
      console.log(body);
    }
  ...
  return (
    <div>
       ...
       <div style={{display:'flex', justifyContent:'center', alignItems:'center'}} className="Banner">
          <img style={styleBorderFr} src='/images/fr.png' alt='fr-flag' onClick={() => updateLang('fr')} />
          <img style={styleBorderEn} src='/images/uk.png' alt='gb-flag' onClick={() => updateLang('en')} /> 
        </div>
